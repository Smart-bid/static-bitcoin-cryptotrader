...
export default class App extends Component {
    ...
    handleSubmit = () => {
        this.props.handleSubmit()
            .then(res => (res.redirectUrl && res.success) ? window.location = res.redirectUrl : this.setState({responseError: res.error}, this.handleStep(this.state.step + 1)))
    };
    ...
    render() {
        ...
        if (this.state.page === 'main') {
            return (
                <div className='App'>
                    <TopSection {...this.props} handleStep={this.handleStep} handleSubmit={this.handleSubmit} step={this.state.step} lastError={this.state.responseError}/>
